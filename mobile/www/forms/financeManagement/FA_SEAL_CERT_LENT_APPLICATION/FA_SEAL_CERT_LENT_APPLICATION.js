...
var SEAL_CERT_LENT_APPROVE_do = {
  afterDataLoad: function ($scope, commonService) {
    SEAL_CERT_LENT_APPROVE_do.initAPPROVALAuto($scope, commonService);
...
var SEAL_CERT_LENT_ADD_do = {
  afterDataLoad: function ($scope, commonService) {
    SEAL_CERT_LENT_ADD_do.initAPPROVALAuto($scope, commonService);
    //OA_TRAVEL_APPLICATION_TA_Sure.getAttachment($scope, commonService);
