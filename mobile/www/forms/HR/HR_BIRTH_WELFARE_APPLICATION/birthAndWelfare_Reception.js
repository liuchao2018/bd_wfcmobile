...
var HR_BIRTH_WELFARE_APPLICATION_RECEPTION = {
    ...
    getAttachment : function ($scope, commonService) {//获取附件信息
      var fieldToken = $scope.formData.HR_BIRTH_WELFARE_APPLICATION[0].BIRTH_CERTIFICATE.val;
      if (fieldToken && fieldToken != "") {
        var _method = "streamSupportService.getAttachmentInfos";
        var _param = [];
        var o = {};
        o.fieldToken = fieldToken;
        _param.push(o);
        commonService.callMethod(_method, _param, function (data) {
          if (data && data.attachments) {
            $scope.formData.HR_BIRTH_WELFARE_APPLICATION[0].BIRTH_CERTIFICATE.attach = data.attachments;
          }
        });
      }
    },
...
var HR_BIRTH_WELFARE_APPLICATION_ADD = {
    afterDataLoad: function ($scope, commonService) {
